...
public class ProductRepositoryImpl implements ProductRepository {
	...
	private static final Logger logger = (Logger) LogManager.getLogger(ProductRepositoryImpl.class);
	...
	public ProductRepositoryImpl(JdbcTemplate jdbcTemplate, DataSource dataSource) {
		...
		this.simpleJdbcInsert = new SimpleJdbcInsert((javax.sql.DataSource) dataSource).withTableName("products")
